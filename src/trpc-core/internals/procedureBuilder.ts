 ...
 * @internal
 */
export interface BuildProcedure<TType extends ProcedureType, TParams extends ProcedureParams, TOutput>
  extends Procedure<
    TType,
...
export interface ProcedureBuilder<TParams extends ProcedureParams> {
  ...
  ): $ProcedureBuilder extends ProcedureBuilder<infer $TParams> ? CreateProcedureReturnInput<TParams, $TParams> : never;
  /**
   * Query procedure
   */
  query<$Output>(
...
export function createBuilder<TConfig extends AnyRootConfig>(
  ...
  return {
    ...
    query(resolver) {
      return createResolver({ ..._def, query: true }, resolver) as AnyQueryProcedure;
    },
    mutation(resolver) {
      return createResolver({ ..._def, mutation: true }, resolver) as AnyMutationProcedure;
    },
    subscription(resolver) {
      return createResolver({ ..._def, subscription: true }, resolver) as AnySubscriptionProcedure;
    },
  };
}
