...
import { Simplify, WithoutIndexSignature } from "../util-types";
...
export type Overwrite<TType, TWith> = TWith extends any
  ? TType extends object
    ? {
        [K in keyof WithoutIndexSignature<TType> | keyof WithoutIndexSignature<TWith>]: K extends keyof TWith // Exclude index signature from keys
          ? TWith[K]
